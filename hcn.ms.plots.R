...
### ------------------------------------------------------------------------
### ------------------------------------------------------------------------
####  ----------- FIGURE 5 - Method comparison study 
...
### ------------------------------------------------------------------------
### ------------------------------------------------------------------------
####  -----------FIGURE 6 - Dessicator x Cup Accuracy Study 
...
text(x=-0.58,y=1.175, labels='y = 0.95x + 1.01',cex=1.0)
...
### ------------------------------------------------------------------------
### ------------------------------------------------------------------------
####  -----------FIGURE 7 - Standard Curve with Amygdalin 
...
text(x=135,y=3.5, labels=r2.cup,cex=1.0,col = "blue")
r2.MP <- expression(paste(" ",R^2 ," = 0.99"))
text(x=80,y=4.35, labels=r2.MP,cex=1.0,col = "red")
...
# amygdalin chemical structure will be pasted onto this plot for aesthetics 



### ------------------------------------------------------------------------
### ------------------------------------------------------------------------
#### ----------- FIGURE 8 - Inter- and Intraspecific Variation Figure 
...
### ------------------------------------------------------------------------
### ------------------------------------------------------------------------
####  ----------- FIGURE 9 - Intraspecific / Within Branch Figure 
...
### ------------------------------------------------------------------------
### ------------------------------------------------------------------------
#### -----------  FIGURE 10 - HCN Induction with Mechanical Damage Figure  
...
### ------------------------------------------------------------------------
### ------------------------------------------------------------------------
#### ----------- FIGURE 11 - P. biflora HCN distribution figure  
...
plot(HCN~leaf,data=b0,pch=19,col="#440154FF",ylim=c(0,13),xlim=c(0,25),
     ...
     main=expression(paste("Distribution of ", italic("P. biflora")," Leaf HCN with Age and Sampling Time")))
...
### ------------------------------------------------------------------------
### ------------------------------------------------------------------------
####  ----------- FIGURE 13 - Dynamic control of CNs by P. biflora
...
plot(biflora~leaf,data=b2,pch=19,col="red",ylim=c(0,7),xlim=c(0,27),
     xlab="leaf position",ylab=expression(paste("HCN (", mu, "mol/g)")),
     main=expression(paste("Dynamic HCN Activity in ", italic("P. biflora"))))
...
### ------------------------------------------------------------------------
### ------------------------------------------------------------------------
#### ----------- FIGURE 14 - Heliconius doris Feeding Iduced Reduction in Cyanogenesis
...
### ------------------------------------------------------------------------
### ------------------------------------------------------------------------
####  ----------- FIGURE S1 - Spectrophotometer comparison 
...
### ------------------------------------------------------------------------
### ------------------------------------------------------------------------
####  ----------- FIGURE S2 - Comparison with Engler & Gilbert (2007) colorimetric CN data 
...
### ------------------------------------------------------------------------
#### ----------- Table S1 - Sample size of each tissue type by species
